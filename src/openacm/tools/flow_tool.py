...
- set: {"name": str} — guarda un valor en una variable con nombre, referenciable luego como {{name}}. Pines de flujo: entrada "default", salida "default". Pin de dato de entrada (opcional): "value" — si no se conecta, usa la salida del nodo anterior en el flujo. Pin de dato de salida: "value" (el valor guardado).
