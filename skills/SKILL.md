...
python3 skill_security_auditor.py /path/to/skill-name/
...
python3 skill_security_auditor.py /path/to/skill-name/ --strict

# Output JSON report
python3 skill_security_auditor.py /path/to/skill-name/ --json
```
...
python3 skill_security_auditor.py https://github.com/user/skill-repo --skill my-skill --cleanup
```
...
for skill in skills/*/; do
  python3 skill_security_auditor.py "$skill" --json >> audit-results.jsonl
done
```
